...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  const startup = [
    ...
    ["ConsistencyCoach", "init"],
    ["CognitiveFatigueCoach", "init"],
    ["BehavioralDashboardEngine", "init"],
    ["LearningCoach", "init"],
    ["GuardianDashboardEngine", "init"],
    ["IntelligentXPEngine", "init"],
    ["LevelSystem", "init"],
    ["BadgeRuleEngine", "init"],
    ["SecretDiscoveryEngine", "init"],
    ["BadgeCollectionEngine", "init"],
    ["BadgeTimelineEngine", "init"],
    ["IntelligentNotificationEngine", "init"],
    ["BadgeReportEngine", "init"],
    ["BadgeAIIntegrationEngine", "init"],
    ["IntelligenceCenter", "init"],
    ["ExamStudyPlannerEngine", "init"],
    ["MissionEngine", "init"],
    ["Gamification", "init"],
    ["TutorEngine", "init"],
    ...
    ["ConsistencyCoachUI", "init"],
    ["CognitiveFatigueUI", "init"],
    ["BehavioralDashboardUI", "init"],
    ["LearningCoachUI", "init"],
    ["GuardianDashboardUI", "init"],
    ["IntelligentXPUI", "init"],
    ["LevelSystemUI", "init"],
    ["BadgeRuleUI", "init"],
    ["BehavioralBadgeUI", "render"],
    ["RecoveryBadgeUI", "render"],
    ["SecretBadgeUI", "render"],
    ["BadgeCollectionUI", "init"],
    ["BadgeTimelineUI", "init"],
    ["IntelligentNotificationUI", "init"],
    ["BadgeReportUI", "init"],
